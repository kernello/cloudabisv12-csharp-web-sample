            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(images))
                {
                    ...
                    if (!string.IsNullOrEmpty(token))
                    {
                        ...
                        serverResult.Text = CloudABISResultParser.GetBiometricMatchingResponse(response, EnumOperationName.Identify).Message;//JsonConvert.SerializeObject(response, Formatting.Indented);
