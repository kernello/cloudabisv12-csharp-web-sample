...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function captureBiometric() {
            ...
            var regId = document.getElementById('txtUpdateID').value;
            if (regId == '') {
                document.getElementById('<%= serverResult.ClientID %>').innerHTML = "Please put update id first!"
                return;
            }
            showLoader();
    ...
    <div class="formWrapper">
        <form class="commonForm updateForm" id="form1" runat="server">
            ...
            <div>
                ...
                <asp:Button ID="btnSubmit" runat="server" Text="Update" Enabled="true" Style="display: none" OnClick="btnUpdate_Click" Height="40px" />
